...
{
    public class ContactQualityInsightManager3D : ContactQualityBaseManager3D
    {
        [SerializeField] GameObject AF3, T7, PZ, T8, AF4, CMS;

        [Inject(Id = "AF3")] ContactQualityNodeView3D AF3View;
        [Inject(Id = "T7")] ContactQualityNodeView3D T7View;
        [Inject(Id = "PZ")] ContactQualityNodeView3D PZView;
        [Inject(Id = "T8")] ContactQualityNodeView3D T8View;
        [Inject(Id = "AF4")] ContactQualityNodeView3D AF4View;
        [Inject(Id = "CMS")] ContactQualityNodeView3D CMSView;
