...
{
    public class ContactQualityController3D : BaseCanvasView
    {
        [SerializeField] private ContactQualityBaseManager3D insight;
        [SerializeField] private ContactQualityBaseManager3D epoc;
        [SerializeField] private float updateCQInterval = 0.5f;

        ConnectedDevice connectedDevice;
        HeadsetGroup headsetGroup;
        ContactQualityBaseManager3D activeDevice;
